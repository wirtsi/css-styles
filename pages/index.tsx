...
import { lite, dark } from "../styles/theme.css";
import {backdrop} from "../styles/index.css"
...
export default function Home() {
  ...
  return (
    <div className={theme == "light" ? lite : dark}>
      <div className={backdrop}>
        ...
        <footer>
          ...
          This is to demonstrate scoping of css variables (this is the global
          style vs the local style of the buttons above)&nbsp;
          <Icon
